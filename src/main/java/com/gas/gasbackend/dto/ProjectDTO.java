...
public class ProjectDTO {
    ...
    public ProjectDTO(String id, String name, String description, int likedBy, Set<Skill> skillsUsed, Set<User> collaborators, Set<Slice> slices, int commentCount) {
        this.id = id;
        this.name = name;
    ...
    public static ProjectDTO fromEntity(Project project) {
        ...
        Set<Skill> skillsUsed = project.getSkillsUsed();
